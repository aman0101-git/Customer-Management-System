...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    // PHASE 1: bg-black/80 was overpowering in both modes; foreground/40 with
    // backdrop-blur reads as a proper modal scrim against any background.
    className={cn(
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      // PHASE 1: bg-background → bg-popover for stronger elevation contrast
      // against the (now blurred) overlay. rounded-lg promoted to rounded-xl.
      className={cn(
