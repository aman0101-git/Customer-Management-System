...
export default function FollowUpDashboard() {
  ...
  // --- STYLE HELPER (Updated for Professional Look) ---
      ...
      <div className="space-y-4">
        {displayList.length === 0 ? (
          ...
          displayList.map((customer) => {
            ...
            return (
              <div 
                key={customer.agent_customer_id} 
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center p-5 gap-5">
                  ...
                  {/* Left: Status Icon & Date (Mobile Optimized) */}
                  ...
                  <div className="flex items-center">
                    <button 
                      onClick={() => navigate(`/agent/customers/resolve?edit=${customer.agent_customer_id}`)}
